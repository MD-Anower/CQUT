...
print('MLR with Categorical Predictor');
...
% this is the code for Regression Learner  app the code won't be run
% because of the non existance Regression Learner app on matlab 2014
